...
<div align='center'>
<h1>🎓 Studium: 게임처럼 즐거운 스터디의 시작</h1>
</div>


### 🤔 이런 고민에서 시작했습니다

기존의 스터디 플랫폼은 단순히 사람을 모으고 관리하는 데 그쳐, 참여자들의 학습 의지를 꾸준히 유지하기 어려웠습니다. 
스터디를 지속할 명확한 동기와 즉각적인 성취감이 부족했기 때문이라고 판단하였습니다.

### 💡 `Studium`의 해결책

`Studium`은 이 문제를 해결하기 위해 **'게이미피케이션(Gamification)'** 요소를 도입했습니다.

1.  **눈에 보이는 성취감, 아바타 시스템**
    > 스터디 활동으로 얻은 리워드 포인트를 소모하여 자신만의 아바타를 꾸밀 수 있습니다. 이는 사용자의 노력을 시각적으로 보여주어 즉각적이고 지속적인 성취감을 제공합니다.

2.  **몰입을 이끌어내는 즐거운 경쟁, 서바이벌 스터디**
    > 4주간 진행되는 서바이벌 스터디는 매주 새로운 퀴즈를 제공합니다. 퀴즈를 통과해 생존하며 살아남는 경우 큰 보상을 획득하는 과정을 통해, 공부와 목표 달성 자체를 하나의 즐거운 게임처럼 느끼게 합니다.
...
### 1. 아바타 커스터마이징
사용자는 개인 기본 아바타를 받으며 포인트를 소모해 의상, 외형을 커스텀할 수 있습니다. 
해당 포인트는 스터디 목표달성, 출석, 서바이벌 스터디 우승을 통해 수급할 수 있습니다.
그렇게 꾸며진 아바타는 사용자의 프로필로 변경되고 스터디 홈에서 스터디원 아바타로서 노출 됩니다.

### 2. 서바이벌 스터디
많은 사람들이 공통적으로 참여할 수 있는 학습주제를 바탕으로 서비스 제공자가 생성합니다.
해당 학습 주제에 대한 퀴즈는 LLM과 RabbitMQ를 이용하여 각 스터디마다 비동기적으로 생성됩니다.
통과기준은 주차별로 다르고 통과기준을 충족하지 못한 경우 탈락처리 됩니다.

### 3. 리워드 시스템
출석, 목표 달성, 서바이벌 스터디를 통해 리워드를 획득할 수 있습니다.
얻은 리워드는 아바타, 테마, 배경사진을 구매하는데 사용해 꾸미기가 가능합니다.

### 4. 스터디 보조
스터디 시간, 출석 체크, 주간 목표달성 여부를 확인해 현재까지의 활동내역을 확인할 수 있으며
스터디룸 내에서 타이머를 이용해 공부시간을 기록할 수 있습니다.
해당 내역들은 개인 페이지에서 지표로서 확인할 수 있습니다.
